        ...
        {Object.entries(widgets).map(([pageName, pageWidgets]) => (
          ...
          >
            ...
            <div className="divide-y divide-gray-200">
              {pageWidgets &&
                (Array.isArray(pageWidgets) ? pageWidgets : [pageWidgets]).map(
                  (widget) => (
                    <div
                      key={widget.id}
                          ...
                          <div
                            className={
                              widget.price === ""
                                ...
                                ? "text-xs text-white bg-green-600 px-2 py-1 rounded-full inline-block"
                                : "text-xs text-white bg-orange-400 px-2 py-1 rounded-full inline-block"
                            }
                          >
                            {widget.price === "" ||
                            widget.price?.toLowerCase() === "free"
